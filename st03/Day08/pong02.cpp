...
// Now that we have the left paddle,
// let's do the same for the right paddle,
// but this we have to put it on the right side of the screen
// and make it move with the Up and Down keys.
void render()
{
}
