...
// Whenever the D key is pressed the circle should move to the right, 5 pixels at a time.
//
// Hint: You can use a global variable - a variable that you define outside of the render() function.
void render()
{
}
